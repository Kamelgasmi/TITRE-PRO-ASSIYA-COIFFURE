...
<body id="pageAjoutProductsAdmin">
        <div class="container-fluid justify-content-center">
            <div class="row no-gutter justify-content-center ">
                <form class="col-md-12 text-white justify-content-center" method="POST" action="ajoutProductsAdmin.php" >
                    <div>
                    <h1 class="text-secondary text-center mb-5 mt-5">AJOUTER UN PRODUIT</h1>
                        ...
                        <div class=" boxName text-center col-md-6 offset-md-3 <?= count($formErrors) > 0 ? (isset($formErrors['name']) ? 'has-danger' : 'has-success') : '' ?>" >
                            ...
                            <li><input id="name" name="name" type="name" placeholder="Entrez le nom du produit" class="form-control <?= count($formErrors) > 0 ? (isset($formErrors['name']) ? 'is-invalid' : 'is-valid') : '' ?>"  /></li>
                        ...
                        <div class="boxQuantity text-center col-md-6 offset-md-3 <?= count($formErrors) > 0 ? (isset($formErrors['quantity']) ? 'has-danger' : 'has-success') : '' ?> ">
                            ...
                            <li><input id="quantity" name="quantity" type="quantity" placeholder="Entrez la quantité" class="form-control <?= count($formErrors) > 0 ? (isset($formErrors['quantity']) ? 'is-invalid' : 'is-valid') : '' ?>" /></li>
                        ...
                        <div class=" boxPrice text-center col-md-6 offset-md-3 <?= count($formErrors) > 0 ? (isset($formErrors['price']) ? 'has-danger' : 'has-success') : '' ?> " >
                            ...
                            <li><input id="price" name="price" type="address" placeholder="Entrez le prix" class="form-control <?= count($formErrors) > 0 ? (isset($formErrors['price']) ? 'is-invalid' : 'is-valid') : '' ?>" /></li>
                        ...
                        <div class=" boxWeight text-center col-md-6 offset-md-3 <?= count($formErrors) > 0 ? (isset($formErrors['weight']) ? 'has-danger' : 'has-success') : '' ?>" >
                            ...
                            <li><input id="weight" name="weight" type="weight" placeholder="Entrez le poids" class="form-control <?= count($formErrors) > 0 ? (isset($formErrors['weight']) ? 'is-invalid' : 'is-valid') : '' ?>"/></li>
